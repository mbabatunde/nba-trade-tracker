...
// Favicon: the NBA Swaps emblem — an homage to the league's silhouette mark.
// A vertically split badge (brand orange | deep navy) with a white dribbling
// player, an orange basketball, and swap arrows for the trade motif. Colors
// are inlined because OG images can't use CSS tokens.
const ORANGE = '#e35205'
const NAVY = '#17233f'
const WHITE = '#ffffff'
    ...
    (
      <div style={{ display: 'flex', width: '100%', height: '100%' }}>
        <svg width="64" height="64" viewBox="0 0 48 48">
          ...
          <g clipPath="url(#b)">
            <rect width="48" height="48" fill={ORANGE} />
            <rect x="24" width="24" height="48" fill={NAVY} />
            <g
              fill="none"
              stroke={WHITE}
              strokeOpacity="0.32"
            ...
            />
            <circle cx="36.2" cy="14" r="3.6" fill={ORANGE} stroke={NAVY} strokeWidth="0.6" />
            <g fill="none" stroke={NAVY} strokeWidth="0.7" strokeLinecap="round">
